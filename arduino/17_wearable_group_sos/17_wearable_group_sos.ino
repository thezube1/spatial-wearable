...
//
//  BEHAVIOR (firmware 17 — group SOS):
...
//    - SOS broadcast (NEW in 17): triple-tap from HOME or NAV enters local
//      SOS; while SOS is active, the watch broadcasts SosMessage over ESP-NOW
//      at 1 Hz to all peers. Receivers whose candidate list contains the
//      sender's MAC show a red overlay with the sender's name and vibrate
//      a 3-pulse pattern. A short tap dismisses the overlay locally. The
//      original sender's 3-second-hold exit fires a flurry of cancel packets
//      so all receivers' overlays clear together. Receivers also self-clear
//      after 10 s of silence in case the sender drops off the air.
//
// ============================================================
