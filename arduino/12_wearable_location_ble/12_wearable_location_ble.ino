// Full Spatial Wearable — Phone Indicator build (11)
// Fork of 10_wearable_persistent_pairing. Adds a small BLE/phone icon in the
// top-right of the main screen that reflects whether an authenticated iOS
// central is currently connected over BLE. All other behaviour preserved.
//
